...
if(isset($_GET['entity']) && isset($_GET['action']) && isset($_GET['id'])) {
	...
	if($action == "delete"){
		...
		if($entity == "post"){
			...
			$q = "UPDATE post SET category='0' WHERE category='$id'";
		}
...
// Post that have not bee approved
            ...
            <table class="table table-striped">
              ...
              <?php  while($row = $categories->fetch_assoc()) { ?>
                <tr>
                  ...
                  <td><a href="new_categories.php?category=<?php echo $row['id'] ?>" class="btn btn-warning">Edit</a> 
